...
export const Payments = () => {
  return (
    <section id="buy-section" className="container -mt-11 mb-36">
      <p className="mb-2 text-sm text-purple xl:text-2xl">
        Aby kupić Matrycę Losu wystarczy napisać do nas przez Instagram. (Skontaktuj się z nami
        bezpośrednio na naszym profilu w{' '}
        <a className="text-blue-800" href="https://www.instagram.com/matrycalosu">
          Instagramie
        </a>{' '}
        albo na{' '}
        <a className="" href="https://www.facebook.com/profile.php?id=61551597432262">
          Facebook
        </a>
        ), aby uzyskać więcej informacji oraz dokonać zakupu. Jesteśmy tutaj, aby odpowiedzieć na
        wszystkie Twoje pytania i pomóc w przejściu przez proces zakupu.
      </p>
      <a className="text-blue-800 " href="https://www.instagram.com/matrycalosu">
